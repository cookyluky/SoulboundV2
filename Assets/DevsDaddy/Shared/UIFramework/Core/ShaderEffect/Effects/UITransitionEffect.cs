...
{
    [AddComponentMenu("UIFramework/Effects/Transition Effect", 5)]
    public class UITransitionEffect : BaseMaterialEffect
    {
        ...
        public override void ModifyMaterial(Material newMaterial, Graphic graphic)
        {
            ...
            newMaterial.shader = Shader.Find(string.Format("UIFramework/{0} (UITransition)", newMaterial.shader.name));
