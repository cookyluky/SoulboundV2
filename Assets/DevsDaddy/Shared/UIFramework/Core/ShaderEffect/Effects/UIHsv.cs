...
{
    [AddComponentMenu("UIFramework/Effects/HSV Modifier", 4)]
    public class UIHsv : BaseMaterialEffect
    {
        ...
        public override void ModifyMaterial(Material newMaterial, Graphic graphic)
        {
            ...
            newMaterial.shader = Shader.Find(string.Format("UIFramework/{0} (UIHSV)", newMaterial.shader.name));
